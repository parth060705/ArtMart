...
export default function FilterSidebar({
  ...
  return (
    <aside
      className="w-full md:w-64 bg-[var(--card)] rounded-2xl shadow-md font-sans"
      style={{ fontFamily: "Poppins" }}
    >
      <div className="p-6 flex flex-col gap-8 overflow-y-auto max-h-[80vh] scrollbar-thin scrollbar-thumb-[var(--primary)] scrollbar-track-transparent">
                ...
                <button
                  className={`w-full text-left px-3 py-2 rounded-lg transition-colors font-medium ${
                    selectedCategory === cat
                      ...
                      : "hover:bg-[var(--primary)]/10 text-[var(--foreground)]"
                  }`}
