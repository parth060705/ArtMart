    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
        ...
        <nav className="flex flex-wrap gap-4 justify-center w-full md:w-auto">
          ...
          {/* ------------------------------------------------------------------------------------------- */}
          <a href="/user_manage" className="text-base hover:text-[var(--primary)] transition-colors font-medium">user manage</a>
          <a href="/artwork_manage" className="text-base hover:text-[var(--primary)] transition-colors font-medium">artwork manage</a>
          {/* ------------------------------------------------------------------------------------------ */}
