                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1 mt-0.5">
                            ...
                            <span className="ml-1 text-xs text-[var(--muted-foreground)]">1 week ago</span>
                        </div>
                    </div>
                </div>
                <button className="text-[var(--muted-foreground)] hover:text-[var(--foreground)] p-1.5 rounded-full hover:bg-[var(--muted)] self-start sm:self-center">
