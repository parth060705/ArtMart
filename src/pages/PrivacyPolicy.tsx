        ...
        <div className="min-h-screen bg-background py-12 pb-24 md:pb-5 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none text-foreground">
                    <p className="mb-8">
                        This Privacy Policy explains how <span className="font-semibold">Auroraa</span> collects, uses, and protects your information when you use our social media and e-commerce services.
                    </p>
                    ...
                    <div className="space-y-8">
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li><span className="font-medium">Account Information:</span> Name, email, phone number, profile details.</li>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-foreground mb-4">8. Changes to Policy</h2>
