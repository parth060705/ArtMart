        ...
        <div className="min-h-screen bg-background py-12 pb-24 md:pb-5 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none text-foreground">
                    <p className="mb-8">
                        Welcome to <span className="font-semibold">Auroraa</span> ("we," "our," or "us"). These Terms & Conditions govern your use of our platform, which combines social networking features with e-commerce services. By accessing or using our app/website, you agree to these Terms. If you do not agree, please do not use our services.
                    </p>
